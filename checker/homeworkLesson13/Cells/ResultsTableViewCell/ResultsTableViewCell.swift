...
class ResultsTableViewCell: UITableViewCell {
    ...
    func setData(with play: Play) {
        ...
        let players = play.players ?? [] //  CoreDataManager.shared.getPlayer(by: play)
        ...
        self.winnerPlayer1.text = players[0].winner ? "winner_results".localized : "loser_results".localized
        self.winnerPlayer2.text = players[1].winner ? "winner_results".localized : "loser_results".localized

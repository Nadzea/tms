...
class WeatherInfoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = "http://api.openweathermap.org/data/2.5/weather?q=\(city)&appid=bb3af6a661e716dc3b3bfab4c1c87d6c"
//        let urlForFiveDays = "http://api.openweathermap.org/data/2.5/forecast?q=\(city)&cnt=3&appid=bb3af6a661e716dc3b3bfab4c1c87d6c"
        let urlForFiveDays = "http://api.openweathermap.org/data/2.5/find?lat=57&lon=-2.15&cnt=3&appid=bb3af6a661e716dc3b3bfab4c1c87d6c"
    ...
    func updateView(_ weatherData: WeatherData) {
        ...
        DispatchQueue.main.async {
            ...
            print(self.weatherDataForFiveDays)

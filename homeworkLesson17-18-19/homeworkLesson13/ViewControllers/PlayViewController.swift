...
//        let imageforScreen = UIImage(data: readData!)
...
////
////        guard let imageforScreen = try? NSKeyedUnarchiver.unarchiveTopLevelObjectWithData(data) as? UIImage else { return }
//        imageForPlayScreen.image = imageforScreen
//    }
    ...
    @objc func panGesture(_ sender: UIPanGestureRecognizer) {
        ...
        case .ended:
            ...
            chessboard.subviews.forEach { cell in
                if cell.frame.contains(location), cell.backgroundColor == #colorLiteral(red: 0.1411764771, green: 0.3960784376, blue: 0.5647059083, alpha: 1) {
                    currentCell = cell
                    return
                }
            }

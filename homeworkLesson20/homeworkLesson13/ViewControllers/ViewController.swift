...
class ViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        playButton.addShadow(with: .black, opacity: 0.5, shadowOffset: CGSize(width: 5, height: 5))
        resultsButton.addShadow(with: .black, opacity: 0.5, shadowOffset: CGSize(width: 5, height: 5))
        settingsButton.addShadow(with: .black, opacity: 0.5, shadowOffset: CGSize(width: 5, height: 5))
